...
class DetailCli extends StatefulWidget {
  List list;
  int index;
  DetailCli({this.index, this.list});
  @override
  _DetailCliState createState() => new _DetailCliState();
}

class _DetailCliState extends State<DetailCli> {
  void deleteData() {
    var url =
        "http://10.0.2.2/Proyectos/Suritendapp/Movil/clientes/deleteData.php";
    http.post(url,
        body: {'ID_CLIENTES': widget.list[widget.index]['ID_CLIENTES']});
  }
          ...
          child: new Center(
            child: new Column(
              children: <Widget>[
                ...
                Divider(),
                new Text(
                  "Nombre local : ${widget.list[widget.index]['NOM_LOCAL']}",
