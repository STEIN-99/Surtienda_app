...
class _DetailState extends State<Detail> {
  void deleteData() {
    var url =
        "http://10.0.2.2/Proyectos/Suritendapp/Movil/vendedores/deletData.php";
    http.post(url,
        body: {'ID_VENDEDOR': widget.list[widget.index]['ID_VENDEDOR']});
  }
          ...
          child: new Center(
            child: new Column(
              children: <Widget>[
                ...
                Divider(),
                new Text(
                  "RFC : ${widget.list[widget.index]['RFC']}",
                ...
                new Text(
                  "Fecha de nacimiento : ${widget.list[widget.index]['FECHA_NAC']}",
                  style: new TextStyle(fontSize: 18.0),
                ),
                new Padding(
                  padding: const EdgeInsets.only(top: 30.0),
